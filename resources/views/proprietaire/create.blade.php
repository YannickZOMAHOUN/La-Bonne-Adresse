    ...
    <div class="form-inner">
        ...
        >
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="fourchette_prix" name="fourchette_prix"
                           value="{{ old('fourchette_prix') }}" placeholder="ex : 1 500 – 5 000 FCFA" maxlength="100" />
                </div>
            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="phone-input-group">
                            ...
                            <input type="text" id="telephone" name="telephone"
                                   value="{{ old('telephone', '01') }}" placeholder="01 00 00 00 00"
                    ...
                    <div class="form-group">
                        ...
                        <div class="phone-input-group">
                            ...
                            <input type="text" id="whatsapp" name="whatsapp"
                                   value="{{ old('whatsapp', '01') }}" placeholder="01 00 00 00 00"
                                   inputmode="numeric" maxlength="14"
                                   data-benin-phone data-required="false" />
                        </div>
                        <small class="field-help">Même principe : vous complétez seulement les 8 derniers chiffres.</small>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email') }}"
                               placeholder="contact@votre-etablissement.bj" maxlength="150" />
                    </div>
                    <div class="form-group">
            ...
            <div class="form-section">
                ...
                <p class="form-hint">Cette photo sera affichée sur la carte de votre établissement dans les résultats.</p>
            ...
            <div class="form-section">
                ...
                <p class="form-hint">
                    Partagez une ou plusieurs photos ou PDFs de votre menu.
                    Les visiteurs pourront les consulter directement sur votre fiche.
                    Maintenez <kbd>Ctrl</kbd> pour sélectionner plusieurs fichiers.
                </p>
                ...
                <div class="upload-zone" id="menuZone">
                    ...
                    <label for="menus" class="upload-label">
                        ...
                        <span class="upload-hint">JPG, PNG, WebP ou PDF — plusieurs fichiers acceptés</span>
                    </label>
                </div>

                <div id="menusPreview" class="galerie-preview-grid"></div>
            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    phoneInputs.forEach((input) => {
        ...
        input.addEventListener('focus', () => { if (!onlyDigits(input.value)) input.value = '01'; });
    ...
    if (form) {
        form.addEventListener('submit', () => {
            phoneInputs.forEach((input) => {
                ...
                if (!isRequired && digits === '01') { input.value = ''; return; }
...
// ── Aperçu menus (multi-fichiers) ──────────────────────────────────
function previewMenus(input) {
    const container = document.getElementById('menusPreview');
    container.innerHTML = '';
    if (!input.files || input.files.length === 0) return;
    ...
    Array.from(input.files).forEach((file, index) => {
        ...
        if (isPdf) {
            ...
            div.innerHTML = `<span style="font-size:1.8rem">📄</span> <span>${file.name}</span>`;
            container.appendChild(div);
        } else {
            div.className = 'galerie-thumb-preview';
            const reader = new FileReader();
            reader.onload = function (e) {
                div.innerHTML = `
                    <img src="${e.target.result}" alt="Menu ${index + 1}">
                    <span class="galerie-thumb-num">${index + 1}</span>
                `;
            };
            reader.readAsDataURL(file);
